...
class LRUCache:
    ...
    def get(self, key, default=None):
        ...
        if node is None:
            return default
        # TODO: a read counts as a use. This one does not move the node.
        return node[VALUE]

    def put(self, key, value):
        # TODO: an existing key should be updated in place and refreshed,
        # not appended a second time; and the victim is chosen from the wrong
        # end of the list.
